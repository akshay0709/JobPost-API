...
public class JobSearchVerticleTest{
	...
	public void setUp(TestContext context) {
		...
		vertx.deployVerticle(JobSearchVerticle.class.getName(), new DeploymentOptions().setConfig(conf), context.asyncAssertSuccess());
	}
	...
	public void testGetJobs(TestContext context) {
		...
		vertx.createHttpClient().get(8081, "localhost", "/jobs")
				.putHeader("Content-Type", "application/json")
				.putHeader("keyword","Java Developer")
				.putHeader("location","US")
				.handler(response -> {
