...
public class JobSearchConstants {
	public static final String JOB_NAME ="keyword";
	public static final String JOB_LOCATION ="location";
	public static final String JOB_AVAIL ="availability";
	public static final String JOB_POST_DATE ="posted_date";
	public static final String JOB_PAY_RATE ="pay_rate";
	public static final String JOB_SKILLS ="skills";
	public static final String JOB_COMP_NAME ="companyName";
	public static final String JOB_EXP_LEVEL ="experienceLevel";
	public static final String NO_JOBS ="No jobs found.";
